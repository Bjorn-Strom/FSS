    ...
    testList "Css tests" [
        ...
        test "Font" 
            [
                ...
                (fss [ FontFeatureSetting (FontFeatureSetting.Ssss FontFeatureSetting.On) ]), ["font-feature-settings", "\"ss**\""]
                (fss [ FontFeatureSetting (FontFeatureSetting.Ssss FontFeatureSetting.Off) ]), ["font-feature-settings", "\"ss**\" 0"]
