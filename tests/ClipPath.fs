        ...
        testList "ClipPath"
            [
                ...
                test
                    ...
                    [ ClipPath.Inset(pct 40, [ pct 50 :> FssTypes.Global.ILengthPercentage ])]
                    [ "clipPath" ==> "inset(40% round 50%)" ]
                test
                    "ClipPath all sides px"
                    [ ClipPath.Inset(px 40, [ px 50 :> FssTypes.Global.ILengthPercentage  ])]
                    [ "clipPath" ==> "inset(40px round 50px)" ]
                test
                    "ClipPath horizontal-vertical"
                    [ ClipPath.Inset(pct 40, px 50, [ px 50 :> FssTypes.Global.ILengthPercentage  ])]
                    [ "clipPath" ==> "inset(40% 50px round 50px)" ]
                test
                    "ClipPath top-horizontal-bottom"
                    [ ClipPath.Inset(pct 40, px 50, vh 3., [ px 50 :> FssTypes.Global.ILengthPercentage  ])]
                    [ "clipPath" ==> "inset(40% 50px 3.0vh round 50px)" ]
                test
                    "ClipPath top-right-bottom-left"
                    [ ClipPath.Inset(pct 40, px 50, vh 3., rem 2., [ px 50 :> FssTypes.Global.ILengthPercentage ; pct 50 :> FssTypes.Global.ILengthPercentage  ])]
