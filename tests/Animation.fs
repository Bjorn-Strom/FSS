        ...
        testList "Animation"
            [
                ...
                testEqual
                   ...
                   animation
                   (name+"{0%{margin-left:0%;}50%{margin-left:50%;}80%,90%{margin-left:100%;}}")
                let name2, animation =
                    createAnimation
                        [
                            frame 0 [ MarginLeft.value (pct 0) ]
                            frame 50 [ MarginLeft.value (pct 50) ]
                            frame 100 [ MarginLeft.value (pct 100) ]
                        ]
                testEqual
                   "Keyframe are correct"
                   animation
                   (name2+"{0%{margin-left:0%;}50%{margin-left:50%;}100%{margin-left:100%;}}")
                let name3, animation =
                    createAnimation
                        [
                            frames [0; 50; 100] [ MarginLeft.value (pct 0) ]
                            frames [25; 75] [ MarginLeft.value (pct 100) ]
                        ]
                testEqual
                   "Keyframes are correct"
                   animation
                   (name3+"{0%,50%,100%{margin-left:0%;}25%,75%{margin-left:100%;}}")
                testCase
                    "Animation name"
