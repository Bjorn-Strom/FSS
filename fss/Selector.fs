...
module Selector =
    ...
    type Selector =
        static member AdjacentSibling (html: Types.Html) = sprintf " + %A" (Types.htmlToString html)
        static member GeneralSibling (html: Types.Html) = sprintf " ~ %A" (Types.htmlToString html)
        static member Child (html: Types.Html) = sprintf " > %A" (Types.htmlToString html)
        static member Descendant (html: Types.Html) = sprintf " %A" (Types.htmlToString html)
