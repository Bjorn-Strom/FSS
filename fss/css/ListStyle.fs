...
module ListStyle =
    ...
    type ListStyleImage =
        ...
        static member Url (url: string) = ListStyleImage.ListStyleImage url |> listStyleImageValue'
    ...
    type ListStyleType =
        ...
        static member Value(counter: CounterStyle) = Counter.counterValue counter |> listStyleTypeProperty
